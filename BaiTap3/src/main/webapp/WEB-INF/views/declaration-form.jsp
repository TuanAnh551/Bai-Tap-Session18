...
<body>
<form:form modelAttribute="declaration" method="post" action="declaration">
  <h2>Tờ khai y tế</h2>
  ...
  <div class="form-group">
    <form:label path="transportations">Phương tiện đi lại:</form:label>
    <div class="checkbox-group">
      <label><form:checkbox path="transportations" value="Xe máy"/>Xe máy</label>
      <label><form:checkbox path="transportations" value="Xe đạp"/> Xe đạp</label>
      <label><form:checkbox path="transportations" value="Ô tô"/> Ô tô</label>
      <label><form:checkbox path="transportations" value="Khác"/> Khác</label>
    </div>
    <form:errors path="transportations" cssClass="error"/>
  </div>

  <div class="form-group">
    <form:label path="symptoms">Triệu chứng:</form:label>
    <div class="checkbox-group">
      <label><form:checkbox path="symptoms" value="Sốt"/> Sốt</label>
      <label><form:checkbox path="symptoms" value="Ho"/> Ho</label>
      <label><form:checkbox path="symptoms" value="Khó thở"/> Khó thở</label>
      <label><form:checkbox path="symptoms" value="Không triệu chứng"/> Không triệu chứng</label>
    </div>
